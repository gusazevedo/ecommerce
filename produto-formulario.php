    ...
    <form action="adiciona-produto.php" method="post">
        <div class="form-row">
            <div class="form-group col-md-8">
                ...
                <input type="text" class="form-control" id="nomeP" name="nome" placeholder="Nome do produto">
            </div>
            <div class="form-group col-md-4">
                <label for="precoP">Preço</label>
                <input type="text" class="form-control" id="precoP" name="preco" placeholder="Preço do produto">
            </div>
        </div>
